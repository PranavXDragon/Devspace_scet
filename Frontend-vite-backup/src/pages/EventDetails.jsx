    ...
    <div className="min-h-screen bg-bg-soft pb-20 font-jetbrains relative">
      ...
      <div className="w-full relative z-10">
        ...
        <div className="w-full aspect-[4/3] sm:aspect-[16/9] lg:aspect-[21/9] max-h-[60vh] bg-card-hover relative border-y border-border">
            <div className="absolute inset-0 flex flex-col items-center justify-center text-text-muted bg-card border-y border-border-soft">
              <span className="font-sans font-bold text-2xl uppercase tracking-[0.3em] opacity-30">IMAGE</span>
            </div>
