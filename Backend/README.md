# Devspace Backend Setup Documentation

This repository contains the backend for the Devspace Coding Club platform. It's built with Node.js, Express, and Supabase (PostgreSQL), providing a REST API for student registrations, event management, team coordination, certificates, and an administrative dashboard.
...
- `SUPABASE_URL`, `SUPABASE_KEY`: Your Supabase connection credentials.
