/**
 * Devspace Branded Email Templates
 *
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="font-size:11px;color:${BRAND.muted};">
                    &copy; ${new Date().getFullYear()} Devspace Club
                  </td>
...
const adminOtpEmail = (otp) => ({
  html: emailLayout({
    preheader: `Your Devspace admin login OTP is ${otp}`,
    body: `
      ${heading('VERIFY', 'EMAIL')}
      ${paragraph('Use the verification code below to continue signing in to your Devspace account.')}
  ...
  text: `Your Devspace admin login OTP is ${otp}\n\nVERIFY EMAIL.\n\nUse the verification code below to continue signing in to your Devspace account.\n\n${otp}\n\nAuth Status:\n- Verification code generated successfully\n- Valid for 10 minutes\n- Never share this code with anyone\n`,
});
...
const passwordChangeOtpEmail = (otp) => ({
  html: emailLayout({
    preheader: `Your Devspace password change OTP is ${otp}`,
    body: `
...
const passwordChangedSuccessEmail = () => ({
  html: emailLayout({
    preheader: `Your Devspace password was successfully changed`,
    body: `
      ${heading('PASSWORD', 'CHANGED')}
      ${paragraph('Your Devspace admin account password has been successfully updated.')}
  ...
  text: `Your Devspace password was successfully changed\n\nPASSWORD CHANGED.\n\nYour Devspace admin account password has been successfully updated.\n\nIf you did not make this change, please contact the developer team immediately to recover your account.\n`,
});
...
const registrationApprovedEmail = (studentName) => ({
  html: emailLayout({
    preheader: `Welcome to Devspace, ${studentName}! Your registration has been approved.`,
    body: `
      ${heading('WELCOME TO', 'DEVSPACE')}
      ${paragraph(`Dear <strong>${studentName}</strong>,`)}
      ${paragraph('Your registration for Devspace has been <strong style="color:' + BRAND.accent + ';">approved</strong>. You are now officially part of the collective.')}
  ...
  text: `Welcome to Devspace, ${studentName}! Your registration has been approved.\n\nWELCOME TO DEVSPACE.\n\nDear ${studentName},\n\nYour registration for Devspace has been approved. You are now officially part of the collective.\n\nKeep an eye out for upcoming events, workshops, and announcements. We are excited to have you onboard.\n`,
});
...
const registrationRejectedEmail = (studentName) => ({
  html: emailLayout({
    preheader: `Devspace registration update for ${studentName}`,
    body: `
      ${heading('REGISTRATION', 'UPDATE')}
      ${paragraph(`Dear <strong>${studentName}</strong>,`)}
      ${paragraph('We regret to inform you that your registration for Devspace could not be approved at this time.')}
  ...
  text: `Devspace registration update for ${studentName}\n\nREGISTRATION UPDATE.\n\nDear ${studentName},\n\nWe regret to inform you that your registration for Devspace could not be approved at this time.\n\nIf you believe this is a mistake, please contact our support team or resubmit your registration with the correct details.\n`,
});
...
const contactFormReceivedEmail = (userName) => ({
  html: emailLayout({
    preheader: `Thank you for contacting Devspace, ${userName}`,
    body: `
