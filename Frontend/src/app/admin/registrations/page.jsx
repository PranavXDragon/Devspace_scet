...
import StatusBadge from "@/components/admin/registrations/StatusBadge";
import AddRegistrationModal from "@/components/admin/registrations/AddRegistrationModal";
import ImportRegistrationModal from "@/components/admin/registrations/ImportRegistrationModal";
...
export default function Registrations() {
  ...
  const itemsPerPage = process.env.NODE_ENV === "development" ? 10 : 100;
