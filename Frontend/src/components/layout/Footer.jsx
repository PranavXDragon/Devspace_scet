        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-4 lg:col-span-2">
            ...
            <div className="flex items-center gap-3 mt-4">
              ...
              <span className="text-xs text-text font-bold font-sans tracking-widest uppercase">SCET College</span>
            </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              <Link href="/events" className="text-sm text-text-muted hover:text-accent transition-colors">Events</Link>
              <Link href="/team" className="text-sm text-text-muted hover:text-accent transition-colors">Team</Link>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              <Link href="/privacy-policy" className="text-sm text-text-muted hover:text-accent transition-colors">Privacy Policy</Link>
              <Link href="/terms-conditions" className="text-sm text-text-muted hover:text-accent transition-colors">Terms & Conditions</Link>
              <Link href="/accessibility" className="text-sm text-text-muted hover:text-accent transition-colors">Accessibility</Link>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              <Link href="/community-guidelines" className="text-sm text-text-muted hover:text-accent transition-colors">Guidelines</Link>
              <Link href="/event-policy" className="text-sm text-text-muted hover:text-accent transition-colors">Event Policy</Link>
            </div>
          </div>
