              ...
              <div className="flex items-start justify-between mb-10 relative z-10">
               <div className="relative w-16 h-16 flex items-center justify-center">
                  ...
                  <div className="absolute inset-[4px] bg-transparent flex items-center justify-center z-10">
                    <span className="font-sans font-bold text-[0.6rem] uppercase tracking-widest text-text-muted/50 rotate-[-45deg] transition-transform duration-500 group-hover:scale-125">LOGO</span>
                  </div>
                </div>
