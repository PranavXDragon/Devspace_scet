            ...
            >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-5 sm:gap-6 flex-1 pr-0 lg:pr-4">
                ...
                <div className="w-full sm:w-40 h-48 sm:h-32 shrink-0 rounded-2xl overflow-hidden bg-card-hover border border-border-soft relative">
                  <div className="w-full h-full flex flex-col items-center justify-center text-text-muted bg-card-hover border border-border-soft">
                    <span className="font-sans font-bold tracking-widest text-[0.7rem] uppercase opacity-40">IMAGE</span>
                  </div>
                </div>
